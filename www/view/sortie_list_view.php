                             ...
                             <tr>
                               ...
                               <td>
                                <div class="d-flex align-items-center gap-3 fs-6">
                                  <a href=<?php echo "../controller/sortie_add_exec.php?order_id=".$row['id'] ?> type="button" class="btn btn-danger" ><i class="bi bi-arrow-right-square"></i></a>
                                  <!-- <button type="button" class="btn btn-danger"><i class="bi bi-arrow-right-square"></i></button> -->
                                </div>
                               </td>
                             </tr>
                             <?php }?>
