                                ...
                                <div class="d-flex align-items-center gap-3">
                                    ...
                                    <div class="info">
                                        ...
                                        <div class="input-group mb-3">
                                            <input type="text" id="cardcode" disabled class="form-control"
                                        ...
                                        <div class="input-group mb-3">
                                            <input id="cardname" disabled class="form-control form-control-sm"
                                                type="text" placeholder="Nom du client" aria-label="Nom du client">
                                        </div>
                                        <div class="input-group mb-3">
