          ...
          <li>
            ...
            <li>
              <a href="javascript:;" class="has-arrow">
                <div class="parent-icon"><i class="bi bi-box2-fill"></i>
                </div>
              ...
              <ul>
                ...
                <li> <a href="widgets-data-widgets.html"><i class="bi bi-circle"></i>Liste des emplacements</a>
                </li>
              </ul>
            </li>
            <li>
              ...
              <ul>
                ...
                <li> <a href="ecommerce-transactions.html"><i class="bi bi-circle"></i>Liste des transactions</a>
                </li>
              </ul>
            </li>
            <li>
